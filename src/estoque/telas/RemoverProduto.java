...
public class RemoverProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Estoque+ - Remover Produto");
        setResizable(false);

        jLabel1.setText("Insira a ID do produto que deseja remover:");
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        int pdid = Integer.parseInt(txtId.getText());
        if(produtoDAO.remover(pdid)==true) {
